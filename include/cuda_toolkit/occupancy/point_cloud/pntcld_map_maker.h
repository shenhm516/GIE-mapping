...
public:
    ...
    void updateLocalOGM(const Projection& proj,const Projection& proj_prev,const sensor_msgs::PointCloud2::ConstPtr &msg,
                        int3* VB_keys_loc_D, const int time, bool for_motion_planner, int rbt_r2_grids, ros::Publisher _pcl_in_pub);
